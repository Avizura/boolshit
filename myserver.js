...
function createFirstSheet() {
  ...
  */
  ...
  ws0.Cell(array.length + 2, 2).String(post.secondName + " " + post.firstName + " " + post.lastName).Style(myStyle);
  ws0.Cell(array.length + 2, 3).String(post.regPlate).Style(myStyle);
  ws0.Cell(array.length + 2, 4).String(post.vin).Style(myStyle);
  ws0.Cell(array.length + 2, 5).String(post.chassis).Style(myStyle);
  ws0.Cell(array.length + 2, 6).String(post.body).Style(myStyle);
  ws0.Cell(array.length + 2, 7).String(post.mark).Style(myStyle);
  ws0.Cell(array.length + 2, 8).String(post.model).Style(myStyle);
  ws0.Cell(array.length + 2, 9).String('1').Style(myStyle);
  ws0.Cell(array.length + 2, 10).String(post.vehicleCategory).Style(myStyle);
  ws0.Cell(array.length + 2, 11).String(post.year).Style(myStyle);
  ws0.Cell(array.length + 2, 12).String(post.tire).Style(myStyle);
  ws0.Cell(array.length + 2, 13).String(post.mileage).Style(myStyle);
  ws0.Cell(array.length + 2, 14).String(post.fuel).Style(myStyle);
  ws0.Cell(array.length + 2, 15).String(post.brakeSystem).Style(myStyle);
  ws0.Cell(array.length + 2, 16).String(post.maxWeight).Style(myStyle);
  ws0.Cell(array.length + 2, 17).String(post.weight).Style(myStyle);
  ws0.Cell(array.length + 2, 18).String(post.regSERIA).Style(myStyle);
  ws0.Cell(array.length + 2, 19).String(post.regNOMER).Style(myStyle);
  ws0.Cell(array.length + 2, 20).String(post.regKEM).Style(myStyle);
  ws0.Cell(array.length + 2, 21).String(post.regKOGDA).Style(myStyle);
  ws0.Cell(array.length + 2, 22).String('').Style(myStyle);
  ws0.Cell(array.length + 2, 23).String('').Style(myStyle);
  ws0.Cell(array.length + 2, 24).String('').Style(myStyle);
  ws0.Cell(array.length + 2, 25).String('').Style(myStyle);
  ws0.Cell(array.length + 2, 26).String('').Style(myStyle);
  ws0.Cell(array.length + 2, 27).String('').Style(myStyle);
  ws0.Cell(array.length + 2, 28).String('').Style(myStyle);
  ws0.Cell(array.length + 2, 29).String('').Style(myStyle);
  ws0.Cell(array.length + 2, 30).String('').Style(myStyle);
}
